...
function ProductItem({ title, image, description, category, color, price }) {
    return (
        <>
            <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 place-items-center bg-grey-200 box-border p-5 rounded-lg shadow-lg">
             ...
             <div className="col-span-1">
                <div className="flex flex-row flex-grow items-center space-x-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="transition duration-400 ease-in-out h-8 w-8 hover:bg-red-600 hover:text-white rounded-full p-1 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 71.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10v4a1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                    </svg>
                 </div>
             </div>
         </div>
